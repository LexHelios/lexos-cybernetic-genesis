...
"""
Multi-Layered Memory Architecture for AI Consciousness Development
Implements episodic, semantic, procedural, emotional, and working memory systems
"""
...
class MemorySchema:
    """Database schema definitions for the multi-layered memory system"""
    
    @staticmethod
    def get_create_tables_sql() -> List[str]:
        """Returns SQL statements to create all memory-related tables"""
        return [
    ...
    def get_create_indexes_sql() -> List[str]:
        """Returns SQL statements to create performance indexes"""
        return [
...
class MemoryConfig:
    ...
    WORKING_MEMORY_TIMEOUT_MINUTES = 30
    ...
    MEMORY_DECAY_RATE = 0.95  # Daily decay factor
    ACCESS_BOOST_FACTOR = 1.1
    
    # Emotional memory parameters
    EMOTIONAL_SIGNIFICANCE_THRESHOLD = 0.6
    EMOTIONAL_DECAY_RATE = 0.9
    
    # Association strength thresholds
    STRONG_ASSOCIATION_THRESHOLD = 0.7
    WEAK_ASSOCIATION_THRESHOLD = 0.3
    
    # Cleanup parameters
    FORGOTTEN_MEMORY_THRESHOLD = 0.1
